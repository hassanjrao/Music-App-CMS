...
export default class Helpers {
    ...
    static oneToggleClass() {
        ...
        elements.forEach((el) => {
            el.addEventListener("click", () => {
                ...
                // Get all classes
                let cssClasses = el.dataset.class
                    ? el.dataset.class.split(" ")
                    : false;

                // Toggle class on target elements
                document
                    .querySelectorAll(el.dataset.target)
                    .forEach((targetEl) => {
                        if (cssClasses) {
        ...
        elements.forEach((el) => {
            ...
            el.addEventListener("click", (e) => {
                ...
                x =
                    ...
                    parseFloat(
                        getComputedStyle(ripple).width.replace("px", "")
                    ) /
                        2;
                y =
                    e.pageY -
                    ...
                    parseFloat(
                        getComputedStyle(ripple).height.replace("px", "")
                    ) /
                        2;
                ...
                .forEach((tr) => {
                    tr.addEventListener("click", (e) => {
                        if (
                            ...
                            e.target.parentNode.nodeName.toLowerCase() !==
                                "a" &&
                            e.target.parentNode.nodeName.toLowerCase() !==
                                "button" &&
                            e.target.parentNode.nodeName.toLowerCase() !==
     ...
     */
    static jsCkeditor() {
        let ckeditorInline = document.querySelector(
            "#js-ckeditor-inline:not(.js-ckeditor-inline-enabled)"
        );
        let ckeditorFull = document.querySelector(
        ...
        jQuery(".js-maxlength:not(.js-maxlength-enabled)").each(
            (index, element) => {
                ...
                el.addClass("js-maxlength-enabled").maxlength({
                    ...
                    warningClass:
                        el.data("warning-class") || "badge bg-warning",
                    limitReachedClass:
