                        ...
                        <tbody>
                            @foreach ($staffs as $ind => $staff)
                                <tr>
                                    ...
                                    <td>
                                        @if ($staff->image)
                                            <img src="{{ $staff->image_url }}" alt="image" class="img-fluid" >
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('staffs.edit', $staff->id) }}" class="btn btn-sm btn-primary"
                                            data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form id="form-{{ $staff->id }}"
