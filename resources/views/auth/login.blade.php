                    ...
                    <div class="block-content">
                        <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                            ...
                            <form class="js-validation-signin" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="py-3">
                                    <div class="mb-4">
                                        <input type="email" class="form-control form-control-alt form-control-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus id="login-username" name="email" placeholder="Email">
                                        @error('email')
